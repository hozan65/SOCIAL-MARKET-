...
// ✅ Netlify new runtime: MUST return Response
// ✅ Inserts into public.news_feed with schema: source,title,content,slug,published_at
...
export async function handler() {
    try {
        ...
        // ---- 3) Insert to Supabase (ignore duplicates via slug)
        // IMPORTANT: create unique index on news_feed.slug in Supabase:
        // create unique index if not exists news_feed_slug_unique on public.news_feed(slug);
